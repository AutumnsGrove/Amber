...
describe('API Client', () => {
  ...
  describe('getStorageInfo', () => {
    it('should fetch storage info successfully', async () => {
      const mockData = {
        ...
        breakdown: [
          { product: 'blog', category: 'images', bytes: 4000000000, file_count: 50 }
        ]
      };
  ...
  describe('getTrash', () => {
    it('should fetch trash files', async () => {
      const mockTrash = {
        files: [
          { id: 'file_1', filename: 'deleted.jpg', deleted_at: '2025-01-01' }
        ],
        total_size: 5000000
      };
  ...
  describe('getAddons', () => {
    it('should get available and purchased addons', async () => {
      const mockAddons = {
        ...
        purchased: [
          { id: 'addon_1', addon_type: 'storage_50gb', gb_amount: 50, active: true }
        ]
      };
